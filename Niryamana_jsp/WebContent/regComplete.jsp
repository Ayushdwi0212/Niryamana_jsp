...
<head>
	...
	<title>निर्यमणा: Registration successful</title>
</head>
...
<body>
	...
	<content class="column is-centered" id="content">
		<br />
		<br />
		<br />
		You've been registered successfully. Please check your e-mail for a
		mail containing a link for verification.<br />
		<br />
		<br />
		<br />
		<br />
		
		<form id="UserTableCreator" action="userEntry.jsp">
...
<script type="text/javascript" src="js/regComplete.js"></script>
</html>
